...
window.onload = function () {
  document.getElementById("print").addEventListener("click", () => {
      ...
      const a = document.getElementById("output").cloneNode(true);
      const b = document.getElementById("results").cloneNode(true);
      const c = document.getElementById("medications-container").cloneNode(true);
      ...
      var now = new Date();
      var dateString = now.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }).split('/').join('-');
      ...
      <div style="position: absolute; top: 10px; right: 10px; font-size: xx-small;">
          ...
          <div> made by <a href="https://diagnoguide.onrender.com/" target="_blank">DiagnoGuide</a> </div> 
      </div>
      ...
      <p>____________________________________________________________________________________________</p>
          ...
          <div id="subhead" style="text-align: center;font-size: small;">
              ...
              <div><a href="https://github.com/Anil951" target="_blank">GitHub</a>
              <a href="https://www.linkedin.com/in/anilkumarborige/" target="_blank">LinkedIn</a></div>
          </div>
